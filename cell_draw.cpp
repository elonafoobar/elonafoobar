...
void cell_draw()
{
    ...
    if (gdata(37) == 1) {
        if (mdata(6) >= 20 && mdata(6) <= 23) { light_at_m85 -= 50; }
    }
        ...
        for (int cnt_end = cnt + (reph); cnt < cnt_end; ++cnt) {
            ...
            color(0, 0, 0);
            {
                ...
                for (int cnt_end = cnt + (repw); cnt < cnt_end; ++cnt) {
                    ...
                    if (reph(3) == y_at_m85) {
                        if (x_at_m85 == repw(2)) {
                            px_at_m85 = (cdata(1, 0) - scx) * inf_tiles +
                                inf_screenx - 48;
                            if (scxbk == scx) { px_at_m85 -= sxfix; }
                            py_at_m85 = (cdata(2, 0) + 1 - scy) * inf_tiles +
                                inf_screeny;
                            if (scybk == scy) { py_at_m85 -= syfix; }
                            color(0, 0, 0);
                            ...
                            if (cdata(0, 0) == 1) {
                                ...
                                if (py_at_m85 < windowh - inf_verh - 24) {
                                    ...
                                    if (mdata(6) == 1) {
                                        ...
                                        grotate(10, ani_at_m85,
                                            cdata(83, 0) * 48, 0, 16, 24);
                                    } else {
                                        if (chipm(0, ground_at_m85) == 3) {
                                            ...
                                            grotate(10, ani_at_m85,
                                                cdata(83, 0) * 48 + 28, 0, 24,
                                                16);
                                            gmode(2, 32, 28);
                                            pos(px_at_m85 + 24, py_at_m85 + 16);
                                            grotate(10, ani_at_m85,
                                                cdata(83, 0) * 48, 0, 24, 24);
                                        } else {
                                            gmode(6 - 1, -1, 110);
                                            color(0, 0, 0);
                    ...
                    if (chipm(2, ground_at_m85)) { wall_at_m85 = 1; }
                    if (chipm(3, ground_at_m85) != 0) {
                        ...
                        gcopy(sel_at_m85, ground_at_m85 % 33 * inf_tiles,
                            ground_at_m85 / 33 * inf_tiles);
                    }
                        ...
                        if (mapsync(x_at_m85, y_at_m85) == msync) {
                            ...
                            if (mefsubref(2, p_at_m85) == 1) {
                                ...
                                grotate(3,
                                    ...
                                    0.785 * efmap(2, x_at_m85, y_at_m85), 32,
                                    32);
                            } else {
                                gmode(4, 32, 32, 150);
                    ...
                    if (map(x_at_m85, y_at_m85, 6) != 0) {
                        if (map(x_at_m85, y_at_m85, 2) ==
                            ...
                            if (p_at_m85 != 999 && p_at_m85 != 0) {
                                ...
                                gcopy(2, p_at_m85 % 33 * inf_tiles,
                                    p_at_m85 / 33 * inf_tiles, inf_tiles,
                                    48 + chipm(6, p_at_m85));
                            }
                            if (mdata(6) == 1) {
                                p_at_m85 =
                                    map(x_at_m85, y_at_m85, 6) / 100000 % 100 +
                                    map(x_at_m85, y_at_m85, 6) / 10000000 * 100;
                        ...
                        if (mapsync(x_at_m85, y_at_m85) == msync) {
                            ...
                            if (mef(1, p2_at_m85) > 10000) {
                                ...
                                if (p_at_m85 == 528) {
                                    ...
                                    pos(0, 1008);
                                    gzoom(22, 20, 5, chipc(0, p_at_m85(1)) + 8,
                                    ...
                                    if (p_at_m85 == 531) {
                                        ...
                                        pos(0, 960);
                                        gcopy(1, chipi(0, p_at_m85),
                                            chipi(1, p_at_m85),
                                            chipi(2, p_at_m85),
                                            chipi(3, p_at_m85));
                                        gfini(chipi(2, p_at_m85),
                                            chipi(3, p_at_m85));
                                        gfdec2(c_col(0, p_at_m85(1)),
                                            c_col(1, p_at_m85(1)),
                                            c_col(2, p_at_m85(1)));
                                        gsel(selcur);
                                    }
                                ...
                                gcopy(1, chipi(0, p_at_m85), chipi(1, p_at_m85),
                                    inf_tiles, inf_tiles);
                            }
                        }
                    }
                            ...
                            stackh_at_m85 = 0;
                            {
                                ...
                                for (int cnt_end = cnt + (3); cnt < cnt_end;
                                    ...
                                    if (p_at_m85 == 528) {
                                        ...
                                        gcopy(1, 0, 768, inf_tiles, inf_tiles);
                                        pos(0, 1008);
                                        gzoom(22, 20, 5, chipc(0, i_at_m85) + 8,
                                            chipc(1, i_at_m85) + 4 +
                                                (chipc(3, i_at_m85) >
                                                    inf_tiles) *
                                                    8,
                                    ...
                                    if (mdata(6) == 1) {
                                        ...
                                        if (chipi(7, p_at_m85) == 0) {
                                            gcopy(1, 0, 960, chipi(2, p_at_m85),
                                                chipi(3, p_at_m85));
                                        } else {
                                            gcopy(1,
                                                chipi(0, p_at_m85) +
                        ...
                        label_0380_internal:
                            ...
                            if (p_at_m85 == 528) {
                                ...
                                if (p_at_m85 == 531) {
                                    ...
                                    pos(0, 960);
                                    gcopy(1, chipi(0, p_at_m85),
                                        chipi(1, p_at_m85), chipi(2, p_at_m85),
                                        chipi(3, p_at_m85));
                                    gfini(
                                        chipi(2, p_at_m85), chipi(3, p_at_m85));
                                    gfdec2(c_col(0, i_at_m85),
                                        c_col(1, i_at_m85), c_col(2, i_at_m85));
                                    gsel(selcur);
                                }
                            }
                            if (mdata(6) == 1) {
                            ...
                            if (c_at_m85 != 0) {
                                if (cbit(967, c_at_m85) == 1) {
                                    if (mdata(6) == 1) {
                                        ...
                                        grotate(10 + c_at_m85, ani_at_m85,
                                            cdata(83, c_at_m85) * 48, 0, 16,
                                            24);
                                    } else {
                                        if (chipm(0, ground_at_m85) == 3) {
                                            gmode(4, 32, 20, 146);
                                    ...
                                    gsel(5);
                                    color(0);
                                    boxf(0, 960, chipc(2, p_at_m85),
                                        chipc(3, p_at_m85) + 960);
                                    pos(0, 960);
                                    gcopy(5, chipc(0, p_at_m85),
                                        chipc(1, p_at_m85), chipc(2, p_at_m85),
                                        chipc(3, p_at_m85));
                                    gfini(
                                        chipc(2, p_at_m85), chipc(3, p_at_m85));
                                    gfdec2(c_col(0, col_at_m85),
                                        c_col(1, col_at_m85),
                                        c_col(2, col_at_m85));
                                    gsel(selcur);
                                    if (mdata(6) == 1) {
                                        ...
                                        grotate(3, 240, 384, 0, 20, 10);
                                        gmode(2, chipc(2, p_at_m85),
                                            chipc(3, p_at_m85));
                                        pos(dx_at_m85 + 24,
                                            dy_at_m85 + 24 -
                                                chipc(4, p_at_m85) / 4);
                                        grotate(5, 0, 960, 0, 24,
                                            chipc(3, p_at_m85) / 2);
                                        if (cdata(79, c_at_m85) != 0) {
                                            draw_emo(c_at_m85, dx_at_m85 + 4,
                                                dy_at_m85 -
                                            ...
                                            pos(dx_at_m85,
                                                dy_at_m85 + 16 -
                                                    ...
                                                    (chipm(0, ground_at_m85) ==
                                                        3) *
                                                        -16);
                                            gcopy(5, 0, 976, chipc(2, p_at_m85),
                                                chipc(3, p_at_m85) - 16);
                                            gmode(2, inf_tiles, inf_tiles);
                                            pos(dx_at_m85,
                                                dy_at_m85 - chipc(4, p_at_m85) -
                                                    (chipm(0, ground_at_m85) ==
                                                        3) *
                                                        -16);
                                            gcopy(5, 0, 960, chipc(2, p_at_m85),
                                                chipc(3, p_at_m85) - 16);
                                        } else {
                                            gmode(6 - 1, -1, 110);
                                            color(0, 0, 0);
                                ...
                                if (cbit(966, c_at_m85) == 1 ||
                                    ...
                                    h_at_m85 = cdata(50, c_at_m85) * 30 /
                                        cdata(51, c_at_m85);
                                    if (h_at_m85 > 30) { h_at_m85 = 30; }
                                    if (c_at_m85 < 16) {
                                        if (mdata(6) != 1) {
                                            pos(dx_at_m85 + 9, dy_at_m85 + 32);
                                            gcopy(3, 480 - h_at_m85, 517,
                                                h_at_m85, 3);
                                        }
                                    } else {
                                        pos(dx_at_m85 + 9, dy_at_m85 + 32);
                                        gcopy(3, 480 - h_at_m85, 513, h_at_m85,
                                            3);
                                    }
                                }
                            }
                    ...
                    if (map(x_at_m85, y_at_m85, 9) != 0) {
                        ...
                        if (gdata(13) > 17 || gdata(13) < 6 ||
                            ...
                            if (mapsync(x_at_m85, y_at_m85) == msync) {
                                light_at_m85 -=
                                    (6 -
                                        limit(dist(cdata(1, 0), cdata(2, 0),
                                                  x_at_m85, y_at_m85),
                                            0, 6)) *
                                    lightdata(4, p_at_m85);
                                pos(dx_at_m85,
                                    dy_at_m85 - lightdata(3, p_at_m85));
                                gmode(5, inf_tiles, inf_tiles,
    ...
    if (light_at_m85 < 25) { light_at_m85 = 25; }
    if (mdata(6) == 1) {
        {
            int cnt = 0;
            for (int cnt_end = cnt + (12); cnt < cnt_end; ++cnt) {
                ...
                if (y_at_m85 < inf_very) {
                    ...
                    gcopy(2, cloud(2, cnt), cloud(3, cnt), cloud(4, cnt),
                        h_at_m85);
                }
            }
        }
                        ...
                        if (p_at_m85 > 0) {
                            if (p_at_m85 < 300) {
                                ...
                                if (p2_at_m85 == 15) {
                                    ...
                                    if (p2_at_m85 == 127) { i_at_m85 = 13; }
                                    if (p2_at_m85 == 223) { i_at_m85 = 14; }
                                    if (p2_at_m85 == 191) { i_at_m85 = 15; }
                                    if (p2_at_m85 == 239) { i_at_m85 = 16; }
