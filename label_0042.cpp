...
int label_0042()
{
    if (tid == 24) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"長年の特訓の成果がスタミナを高める"s,
                    u8"Years of training strengthens your stamina."s);
                traitrefn(3) = lang(u8"あなたは持久力がある[スタミナ+]"s,
                    u8"You have good stamina. [Stamina+]"s);
                traitrefn(4) = lang(u8"あなたはかなり持久力がある[スタミナ++]"s,
                    u8"You have very good stamina. [Stamina++]"s);
                traitrefn(5) = lang(u8"あなたの持久力は恐ろしい[スタミナ上昇]"s,
    ...
    if (tid == 3) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"吸血鬼の友人から血の吸い方を学ぶ"s,
                    u8"Your vampire friend teaches you how to suck blood."s);
                traitrefn(3) = lang(u8"あなたは血を吸うことができる"s,
    ...
    if (tid == 40) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたは仲間を一時的に強くできる"s,
    ...
    if (tid == 13) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"夢の中で近くへの瞬間移動を思いつく"s,
                    u8"You hit upon an idea of insta-teleport from a dream."s);
                traitrefn(3) = lang(u8"あなたは空間を曲げられる"s,
    ...
    if (tid == 14) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) =
                    lang(u8"酒を飲んでいるうちに火を噴けるようになる"s,
    ...
    if (tid == 22) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"突如として眠りの手を覚える"s,
                    u8"Suddenly, you know how to make everyone sleep."s);
                traitrefn(3) = lang(u8"あなたは催眠をかけることができる"s,
    ...
    if (tid == 23) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"毒の研究の結果、毒の手を覚える"s,
                    u8"Researching poisons leads you to a method to poison others."s);
                traitrefn(3) = lang(u8"あなたは毒を盛ることができる"s,
    ...
    if (tid == 21) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたはセクシーだ[魅力+4]"s,
                    u8"You are sexy. [CHR+4]"s);
                traitrefn(4) = lang(u8"あなたはとんでもない色魔だ[魅力+8] "s,
    ...
    if (tid == 5) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"腕相撲の特訓で筋力を高める"s,
                    u8"Training arm wrestling increases your strength."s);
                traitrefn(3) = lang(u8"あなたは腕相撲が強い[筋力+3]"s,
                    u8"You are an arm wrestler. [STR+3]"s);
                traitrefn(4) = lang(u8"あなたは腕相撲の達人だ[筋力+6]"s,
                    u8"You are a good arm wrestler. [STR+6]"s);
                traitrefn(5) = lang(u8"あなたは腕相撲のチャンピオンだ[筋力+9]"s,
    ...
    if (tid == 38) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"会計の技能を磨き税金を減らす"s,
                    u8"Working as an accountant reduces your tax payment."s);
                traitrefn(3) = lang(u8"あなたは税金の計算に強い[税金7%減]"s,
    ...
    if (tid == 39) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたはたまに質の高い補給品を受け取る"s,
                    u8"You sometimes receive quality supplies."s);
                traitrefn(4) = lang(u8"あなたは頻繁に質の高い補給品を受け取る"s,
    ...
    if (tid == 42) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたの祈りは呪いの言葉を掻き消す"s,
    ...
    if (tid == 20) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたは格闘技を会得している[格闘+3]"s,
                    u8"You know martial arts. [Martial Arts+3]"s);
                traitrefn(4) = lang(u8"あなたは拳聖だ[格闘+6]"s,
    ...
    if (tid == 12) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"日々瞑想し詠唱技術を高める"s,
                    u8"Daily meditation increases your casting skill."s);
                traitrefn(3) = lang(u8"あなたの集中力は高い[詠唱+4]"s,
                    u8"You concentrate while casting. [Casting+4]"s);
                traitrefn(4) = lang(u8"あなたは極度に集中できる[詠唱+8]"s,
    ...
    if (tid == 43) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたは盾で攻撃する機会を多く得る"s,
    ...
    if (tid == 44) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたの攻撃は敵を恐怖させない"s,
    ...
    if (tid == 15) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"地底での生活が暗黒への耐性を高める"s,
                    u8"Living in darkness makes you resistant to darkness."s);
                traitrefn(3) = lang(u8"あなたは暗闇に慣れている[暗黒耐性強化]"s,
                    u8"You don't fear darkness. [RES Darkness+]"s);
                traitrefn(4) =
                    lang(u8"あなたは闇の中で生活できる[暗黒耐性強化]"s,
    ...
    if (tid == 18) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"貴族の毒見係のおかげで毒への耐性を得る"s,
                    u8"Being a taster for a noble grants you resistance to poison."s);
                traitrefn(3) = lang(u8"あなたは毒に免疫がある[毒耐性強化]"s,
    ...
    if (tid == 16) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"行商人の元で働き交渉の技術を学ぶ"s,
                    u8"Working under a trader improves your negotiation skill."s);
                traitrefn(3) = lang(u8"あなたは交渉が上手い[交渉+4]"s,
                    u8"You are a negotiator. [Negotiation+4]"s);
                traitrefn(4) = lang(u8"あなたの交渉は神ががっている[交渉+8]"s,
    ...
    if (tid == 17) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"神官の下で修行し信仰を深める"s,
                    u8"Training under a priest deepens your faith."s);
                traitrefn(3) = lang(u8"あなたは信仰に篤い[信仰+4]"s,
                    u8"You really believe in god. [Faith+4]"s);
                traitrefn(4) = lang(u8"あなたは猛烈な信者だ[信仰+8]"s,
    ...
    if (tid == 2) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"苦行を通じてHPを増やす"s,
                    u8"Being an ascetic increases your HP."s);
                traitrefn(3) = lang(u8"あなたは苦行者の見習いだ[HP+5%]"s,
                    u8"You are an apprentice of an ascetic. [HP+5%]"s);
                traitrefn(4) = lang(u8"あなたは立派な苦行者だ[HP+10%]"s,
                    u8"You are a journeyman of an ascetic. [HP+10%]"s);
                traitrefn(5) = lang(u8"あなたは熟練した苦行者だ[HP+15%]"s,
                    u8"You are an expert of an ascetic. [HP+15%]"s);
                traitrefn(6) = lang(u8"あなたは苦行の達人だ[HP+20%]"s,
                    u8"You are a master of an ascetic. [HP+20%]"s);
                traitrefn(7) = lang(u8"あなたは伝説的名苦行者だ[HP+25%]"s,
    ...
    if (tid == 11) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"遺伝子組み換えを行いMPを増やす"s,
                    u8"You gain MP by using gene manipulation."s);
                traitrefn(3) =
                    lang(u8"あなたは魔力の遺伝子を持っている[MP+5%]"s,
                        u8"Your genes contain magic. [MP+5%]"s);
                traitrefn(4) = lang(u8"あなたは魔力の細胞を持っている[MP+10%]"s,
                    u8"Your cells contain magica [MP+10%]"s);
                traitrefn(5) =
                    lang(u8"あなたには魔力の血液が流れている[MP+15%]"s,
                        u8"Your blood contain magic [MP+15%]"s);
                traitrefn(6) = lang(u8"あなたの肉体は魔力を帯びている[MP+20%]"s,
                    u8"Your body is made of magic. [MP+20%]"s);
                traitrefn(7) = lang(u8"あなたは魔力を支配している[MP+25%]"s,
    ...
    if (tid == 6) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) =
                    lang(u8"周りを注意深く観察し、罠の発見を容易にする"s,
                        u8"You search around carefully to spot traps."s);
                traitrefn(3) = lang(u8"あなたは罠に注意している[探知+3]"s,
                    u8"You are cautious about traps. [Detection+3]"s);
                traitrefn(4) = lang(u8"あなたは罠に警戒している[探知+6]"s,
    ...
    if (tid == 4) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"猫を追いかけて速くなる"s,
                    u8"Chasing cats increases your speed."s);
                traitrefn(3) = lang(u8"あなたは速く走ることができる[速度+5]"s,
                    u8"You can run fast. [SPD+5]"s);
                traitrefn(4) = lang(u8"あなたは猫よりも速い[速度+10]"s,
    ...
    if (tid == 7) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"受身を会得しPVを上昇させる"s,
                    u8"You establish your own defensive style."s);
                traitrefn(3) = lang(u8"あなたの防御は石のように硬い[PV+5]"s,
                    u8"Your defense is as hard as stone. [PV+5]"s);
                traitrefn(4) = lang(u8"あなたの守備は鉄壁だ[PV+10]"s,
                    u8"Your defense is as hard as iron. [PV+10]"s);
                traitrefn(5) = lang(u8"あなたの防御は鋼のように固い[PV+15]"s,
    ...
    if (tid == 8) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"敵の動きを見極めDVを上昇させる"s,
                    u8"You learn how to dodge attacks."s);
                traitrefn(3) = lang(u8"あなたは見切れる[DV+4]"s,
                    u8"You can somewhat dodge enemy attacks. [DV+4]"s);
                traitrefn(4) = lang(u8"あなたはかなり見切れる[DV+8]"s,
                    u8"You can dodge enemy attacks. [DV+8]"s);
                traitrefn(5) = lang(u8"あなたの見切りは伝説的だ[DV+12]"s,
    ...
    if (tid == 10) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                traitrefn(2) = lang(u8"回避の技術に磨きをかける"s,
                    u8"You improve your evasion skill."s);
                traitrefn(3) = lang(u8"あなたは回避に長けている[回避+2]"s,
                    u8"You can somewhat evade enemy attacks. [Evasion+2]"s);
                traitrefn(4) = lang(u8"あなたは華麗に回避する[回避+4]"s,
                    u8"You can evade enemy attacks. [Evasion+4]"s);
                traitrefn(5) = lang(u8"あなたは回避の達人だ[回避+6]"s,
    ...
    if (tid == 41) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたは人肉を食べることに抵抗がない"s,
                    u8"You have no trouble eating human flesh."s);
            }
            traitrefn(0) = lang(u8"あなたは人肉の味の虜になった。"s,
                u8"You are charmed by the flavor of human flesh."s);
            traitrefn(1) = lang(u8"あなたは人肉の味に飽きた。"s,
    ...
    if (tid == 25) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたの皮膚は硬い[PV+3]"s,
                    u8"Your skin is hard. [PV+3]"s);
                traitrefn(4) = lang(u8"あなたの皮膚はとても硬い[PV+6]"s,
                    u8"Your skin is very hard. [PV+6]"s);
                traitrefn(5) =
                    lang(u8"あなたは鉄のような皮膚を持っている[PV+9]"s,
                        u8"Your skin is as hard as iron. [PV+9]"s);
            }
            if (trait(tid) < 0) {
                traitrefn(2) = lang(u8"アルビノ"s, u8"Albino"s);
                traitrefn(3) = lang(u8"あなたの皮膚は白い[PV-3]"s,
                    u8"Your skin is white. [PV-3]"s);
                traitrefn(4) = lang(u8"あなたの皮膚は脆い[PV-6]"s,
                    u8"Your skin is fragile. [PV-6]"s);
                traitrefn(5) = lang(u8"あなたの皮膚は崩れている[PV-9]"s,
                    u8"Your skin is collapsing. [PV-9]"s);
            }
            traitrefn(0) = lang(u8"あなたの皮膚は硬くなった。"s,
    ...
    if (tid == 27) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたの傷跡は再生する[自然治癒強化]"s,
            ...
            if (trait(tid) < 0) {
                ...
                traitrefn(3) = lang(u8"あなたは血の気が少ない[自然治癒弱化]"s,
            ...
            traitrefn(0) = lang(u8"あなたの血液は緑っぽくなった。"s,
    ...
    if (tid == 28) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたの脚はしなやかだ[速度上昇]"s,
                    u8"You have lithe legs. [SPD+5]"s);
                traitrefn(4) = lang(u8"あなたの脚はとてもしなやかだ[速度上昇]"s,
                    u8"You have very lithe legs. [SPD+10]"s);
                traitrefn(5) =
                    lang(u8"あなたの脚は理想的な形をしている[速度上昇]"s,
                        u8"You have ideal legs. [SPD+15]"s);
            }
            if (trait(tid) < 0) {
                traitrefn(2) = lang(u8"ねじれた脚"s, u8"Twisted Leg"s);
                traitrefn(3) = lang(u8"あなたの脚はねじれている[速度下降]"s,
                    u8"Your legs are twisted. [SPD-5]"s);
                traitrefn(4) =
                    lang(u8"あなたの脚はとてもねじれている[速度下降]"s,
                        u8"Your legs are very twisted. [SPD-10]"s);
                traitrefn(5) = lang(u8"あなたの脚は折れている[速度下降]"s,
                    u8"Your legs are broken. [SPD-15]"s);
            }
            traitrefn(0) = lang(u8"あなたの脚はしなやかになった。"s,
    ...
    if (tid == 29) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたの腕はひきしまっている[筋力+3]"s,
                    u8"You have well-knit arms. [STR+3]"s);
                traitrefn(4) = lang(u8"あなたの腕は強力だ[筋力+6]"s,
                    u8"You have well-muscled arms. [STR+6]"s);
                traitrefn(5) = lang(u8"あなたの腕は筋肉の塊だ[筋力+9]"s,
                    u8"You have ideal arms. [STR+9]"s);
            }
            if (trait(tid) < 0) {
                traitrefn(2) = lang(u8"弱い腕"s, u8"Weak Arm"s);
                traitrefn(3) = lang(u8"あなたの腕はたるんでいる[筋力-3]"s,
                    u8"Your arms are thin. [STR-3]"s);
                traitrefn(4) = lang(u8"あなたの腕はとてもたるんでいる[筋力-6]"s,
                    u8"Your arms are very thin. [STR-6]"s);
                traitrefn(5) = lang(u8"あなたの腕には筋肉がない[腕力-9]"s,
    ...
    if (tid == 30) {
        if (traitmode == 0) {
            ...
            if (trait(tid) >= 0) {
                ...
                traitrefn(3) = lang(u8"あなたは美声を持っている[魅力+5]"s,
                    u8"Your voice is sweet.[CHR+5]"s);
                traitrefn(4) = lang(u8"あなたの声は全てを魅了する[魅力+10]"s,
                    u8"Your voice charms everyone.[CHR+10]"s);
            }
            if (trait(tid) < 0) {
                traitrefn(2) = lang(u8"かれた声"s, u8"Husky Voice"s);
                traitrefn(3) = lang(u8"あなたの声はかれている[魅力-5]"s,
                    u8"Your voice is hasky.[CHR-5]"s);
                traitrefn(4) = lang(u8"あなたが喋ると皆逃げる[魅力-10]"s,
    ...
    if (tid == 161) {
        ...
        if (cdata(71, 0) > 0) { cdata(71, 0) = cdata(71, 0) * 125 / 100 + 50; }
        stat = 1;
        return stat;
    }
    if (tid == 162) {
    ...
    if (tid == 201) {
        if (traitmode == 0) {
            ...
            if (trait(tid) < 0) {
                ...
                traitrefn(4) =
                    lang(u8"あなたは大きな重力を生み出している[重量+20%]"s,
            ...
            traitrefn(1) = lang(u8"あなたは重力を発するようになった。"s,
    ...
    if (tid == 202) {
            ...
            if (trait(tid) < 0) {
                ...
                traitrefn(3) = lang(u8"あなたの顔はただれている[魅力"s +
                    ...
                    u8"You have sores on your face. [CHR"s +
                        -1 * (4 + cdata(38, 0) / 5) + u8"]"s);
                traitrefn(4) = lang(u8"あなたの顔中に蕁麻疹が出ている[魅力"s +
                        -2 * (4 + cdata(38, 0) / 5) + u8"]"s,
                    u8"Your face is ulcerate. [CHR"s +
                        -2 * (4 + cdata(38, 0) / 5) + u8"]"s);
                traitrefn(5) = lang(u8"あなたの顔は崩れかけている[魅力"s +
                        -3 * (4 + cdata(38, 0) / 5) + u8"]"s,
                    u8"Your face is crumbling. [CHR"s +
                        -3 * (4 + cdata(38, 0) / 5) + u8"]"s);
            }
            traitrefn(0) = lang(u8"あなたの顔のただれは軽くなった。"s,
        ...
        sdata(17, 0) = limit(sdata(17, 0) + trait(tid) * (4 + cdata(38, 0) / 5),
            sdata(17, 0) > 0, 9999);
        stat = 1;
        return stat;
    }
    if (tid == 203) {
        if (traitmode == 0) {
            ...
            traitrefn(1) = lang(u8"あなたの足の裏は蹄に変形した。"s,
    ...
    if (tid == 205) {
        if (traitmode == 0) {
            ...
            traitrefn(1) = lang(u8"あなたの背中に羽が生えた。"s,
    ...
    if (tid == 206) {
        if (traitmode == 0) {
            ...
            traitrefn(1) = lang(u8"あなたの首は太くなった。"s,
    ...
    if (tid == 207) {
        if (traitmode == 0) {
            ...
            traitrefn(0) = lang(u8"あなたの心は落ち着いた。"s,
                u8" A deep sense of peace fills your heart."s);
            traitrefn(1) = lang(u8"あなたは憎しみに支配された。"s,
    ...
    if (tid == 208) {
        if (traitmode == 0) {
            ...
            traitrefn(0) = lang(u8"あなたの頭は元に戻った。"s,
                u8"Your head is normal size now."s);
            traitrefn(1) = lang(u8"あなたの頭は巨大化した。"s,
    ...
    if (tid == 209) {
        if (traitmode == 0) {
            ...
            traitrefn(0) = lang(u8"あなたの頭上から雨雲が消えた。"s,
                u8"Clouds of rain stop following you."s);
            traitrefn(1) = lang(u8"あなたの頭上に雨雲が現れた。"s,
    ...
    if (tid == 210) {
        if (traitmode == 0) {
            ...
            traitrefn(0) = lang(u8"あなたのポーション中毒は消えた。"s,
                u8"You are no longer addicted to potion."s);
            traitrefn(1) = lang(u8"あなたはポーション中毒になった。"s,
    ...
    if (tid == 213) {
        if (traitmode == 0) {
            ...
            traitrefn(0) = lang(u8"あなたの皮膚から甲殻が消えた。"s,
                u8"Your carapace starts to break."s);
            traitrefn(1) = lang(u8"あなたの皮膚は甲殻で覆われた。"s,
                u8"Heavy carapace starts to cover up your skin."s);
            stat = 1;
            return stat;
        }
        sdata(18, 0) = limit(sdata(18, 0) + (20 + cdata(38, 0) / 2) * -1,
            sdata(18, 0) > 0, 9999);
    ...
    if (tid == 214) {
        if (traitmode == 0) {
            ...
            traitrefn(0) = lang(u8"あなたの周囲の空間は元通りになった。"s,
    ...
    if (tid == 215) {
        if (traitmode == 0) {
            ...
            traitrefn(0) = lang(u8"あなたのマナは元通りになった。"s,
                u8"You are no longer a living mana battery."s);
            traitrefn(1) = lang(u8"あなたのマナは杖から魔力を抽出する。"s,
    ...
    if (tid == 216) {
        if (traitmode == 0) {
            ...
            traitrefn(0) = lang(u8"あなたの手は元通りになった。"s,
                u8"Your hands are clean now."s);
            traitrefn(1) = lang(u8"あなたの手から毒が滴り出した。"s,
