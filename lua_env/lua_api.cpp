...
sol::optional<lua_item_handle> create1(const position_t&, int);
sol::optional<lua_item_handle> create1_xy(int, int, int);
...
sol::optional<lua_item_handle> Item::create1(const position_t& position, int id)
{
    return Item::create_xy(position.x, position.y, id, 1);
}

sol::optional<lua_item_handle> Item::create1_xy(int x, int y, int id)
{
    return Item::create_xy(x, y, id, 1);
}
