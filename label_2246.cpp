...
void label_2246()
{
    ...
    case 29:
        ...
        if (gdata(452) == 0)
        {
            ...
            list(0, listmax) = 0;
            listn(0, listmax) =
                lang(u8"止めておこう"s, u8"Not a chance, you worm."s);
            ++listmax;
            buff = lang(
    ...
    case 31:
        ...
        if (gdata(451) == 0)
        {
            ...
            list(0, listmax) = 1;
            listn(0, listmax) =
                lang(u8"引き受ける"s, u8"I'd be happy to help."s);
            ++listmax;
            list(0, listmax) = 0;
    ...
    case 142:
        ...
        if (gdata(252) >= 60)
        {
            ...
            list(0, listmax) = 6;
            listn(0, listmax) =
                lang(u8"レシマスについて"s, u8"Tell me about Lesimas."s);
            ++listmax;
            list(0, listmax) = 5;
            listn(0, listmax) =
    ...
    case 209:
        list(0, listmax) = 2;
        listn(0, listmax) =
            lang(u8"小さなメダル"s, u8"I have some small medals."s);
        ++listmax;
        list(0, listmax) = 3;
        listn(0, listmax) =
    ...
    case 231:
        ...
        if (gdata(457) == 0)
        {
            ...
            list(0, listmax) = 0;
            listn(0, listmax) =
                lang(u8"止めておこう"s, u8"(Don't get involved.)"s);
            ++listmax;
            buff = lang(
    ...
    case 297:
                ...
                if (gdata(467) == 0)
                {
                    ...
                    buff = lang(""s + refchara_str(gdata(268), 2) + u8"を"s +
                        ...
                        u8"The task given to you is this. Find and slay "s +
                            gdata(267) + u8" "s + refchara_str(gdata(268), 2) +
        ...
        if (chatval == 1)
        {
            ...
            buff = lang(
                ...
                u8"There's a task for you. Go find and slay "s + gdata(267) +
                    u8" "s + refchara_str(gdata(268), 2) +
