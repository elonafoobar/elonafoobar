...
void label_2246()
{
    ...
    case 29:
        ...
        {
            RESPONSE(1, lang(u8"いい"s, u8"Yes."s));
            RESPONSE(0, lang(u8"だめ"s, u8"No."s));
            buff = lang(
    ...
    case 30:
        ...
        if (gdata(450) == 0)
        {
            ...
            RESPONSE(0, lang(u8"面倒だ"s, u8"Not now."s));
            buff = lang(
    ...
    case 31:
        ...
        if (gdata(451) == 0)
        {
            ...
            ++listmax;
            RESPONSE(0, lang(u8"面倒だ"s, u8"Don't bother me."s));
            buff = lang(
    ...
    case 34:
        if (chatflag == 0)
        {
            ...
            if (gdata(250) == 1)
            {
                ...
                RESPONSE(0, lang(u8"わかった"s, u8"Alright."s));
                RESPONSE(3, lang(u8"食べた"s, u8"I ate it."s));
            }
            if (gdata(250) == 2)
            {
                listmax = 0;
                ...
                RESPONSE(0, lang(u8"わかった"s, u8"Okay."s));
            }
            if (gdata(250) == 3)
            {
                txt(lang(
            ...
            if (gdata(250) == 4)
            {
                ...
                ++listmax;
                RESPONSE(4, lang(u8"鑑定した"s, u8"Done..."s));
            }
            if (gdata(250) == 5)
            {
                buff = lang(
                ...
                RESPONSE(0, lang(u8"わかった"s, u8"Will do."s));
                list(0, listmax) = 5;
                listn(0, listmax) =
            ...
            if (gdata(250) == -1)
            {
                ...
                RESPONSE(0, lang(u8"何も"s, u8"Nothing."s));
            }
        ...
        if (chatval == 3)
        {
            ...
            tc = tc * 1 + 0;
            RESPONSE(0, lang(u8"えー"s, u8"What!"s));
            chatesc = 1;
            SCENE_CUT();
            listmax = 0;
            buff = lang(
    ...
    case 222:
        ...
        if (gdata(453) == 1000)
        {
            ...
            RESPONSE(1, lang(u8"息の根を止める"s, u8"(End her life.)"s));
            list(0, listmax) = 0;
            listn(0, listmax) =
    ...
    case 223:
        if (gdata(454) == 0)
        {
            RESPONSE(1, lang(u8"こんな嫁でよければ"s, u8"Sure."s));
            list(0, listmax) = 0;
            listn(0, listmax) =
        ...
        {
            RESPONSE(1, lang(u8"嫁を見せる"s, u8"How's this one?"s));
            RESPONSE(0, lang(u8"ふざけるな"s, u8"Forget it."s));
            buff = lang(
    ...
    case 227:
        ...
        if (gdata(456) == 0)
        {
            RESPONSE(1, lang(u8"引き受ける"s, u8"No problem."s));
            RESPONSE(0, lang(u8"面倒だ"s, u8"None of my business."s));
            buff = lang(
    ...
    case 231:
        ...
        {
            RESPONSE(1, lang(u8"いい"s, u8"They are."s));
            RESPONSE(0, lang(u8"だめ"s, u8"Not yet."s));
            buff = lang(
                u8"準備はいいかな？"s,
    ...
    case 243:
        ...
        if (gdata(459) == 0)
        {
            ...
            RESPONSE(1, lang(u8"引き受ける"s, u8"I accept."s));
            list(0, listmax) = 0;
            listn(0, listmax) = lang(
        ...
        {
            RESPONSE(1, lang(u8"いい"s, u8"Okay, let's roll."s));
            RESPONSE(0, lang(u8"だめ"s, u8"I'm not ready yet."s));
            buff = lang(
    ...
    case 247:
        ...
        if (gdata(460) == 0)
        {
            ...
            ++listmax;
            RESPONSE(0, lang(u8"さ、さようなら"s, u8"Oh...God..."s));
            buff = lang(
    ...
    case 280:
        ...
        if (gdata(465) == 0)
        {
            ...
            RESPONSE(0, lang(u8"面倒だ"s, u8"I'm not interested."s));
            buff = lang(
    ...
    case 302:
        ...
        RESPONSE(0, lang(u8"降参する"s, u8"I surrender."s));
    ...
    case 348:
        ...
        ++listmax;
        RESPONSE(0, lang(u8"興味ない"s, u8"Not interested."s));
        buff = lang(
        ...
        if (chatval == 1)
        {
            ...
            RESPONSE(0, lang(u8"いいえ"s, u8"No."s));
            buff = lang(
                u8"よし、本当に改宗していいね？"s,
