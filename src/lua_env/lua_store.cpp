...
void store::bind(sol::state& state)
{
    ...
    state.new_usertype<lua::store>(
        "LuaStore",
        sol::meta_function::new_index,
        [](lua::store& s, std::string key, const sol::object val) {
            s.set(key, val);
        },
        sol::meta_function::index,
        [](lua::store& s, std::string key, sol::this_state tstate) {
...
void store::set(std::string key, const sol::object& val)
{
    ...
    case sol::type::string: obj = val.as<std::string>(); break;
    case sol::type::number: obj = val.as<int>(); break;
    case sol::type::thread: break;
    case sol::type::boolean: obj = val.as<bool>(); break;
    case sol::type::function: break;
    case sol::type::userdata: obj = serialize_userdata(val); break;
    case sol::type::lightuserdata: break;
    case sol::type::poly: break;
    case sol::type::table: obj = val.as<sol::table>(); break;
    }
...
sol::object store::get(std::string key, sol::state_view& view)
{
    ...
    case sol::type::function: break;
    case sol::type::userdata: return deserialize_userdata(obj, view);
    case sol::type::lightuserdata: break;
    case sol::type::poly: break;
    case sol::type::table:
...
sol::object store::deserialize_position(
...
sol::object store::deserialize_userdata(
    const store::object& obj,
    sol::state_view& view)
{
    // Characters and items will be stored in handle tables already.
