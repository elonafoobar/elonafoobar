...
talk_result_t talk_servant_think_of_house_name()
{
...
talk_result_t talk_result_servant_chase_out()
{
...
talk_result_t talk_npc()
{
    ...
    if (chatval == 45)
    {
        return talk_servant_think_of_house_name();
    }
    if (chatval == 46)
    {
    ...
    if (chatval == 59)
    {
        return talk_result_servant_chase_out();
    }
    if (chatval == 60)
    {
