...
void render_shadow(int l, int dx, int dy)
{
    ...
    if (l < 1000)
    {
        // You can see the cell (x), buy cannot see any of cells around the cell
        // (a-h).
        // l in [0, 256)
        for (int i = 0; i < 1 + (deco[l]._2 != 0); ++i)
        {
            if (deco[l]._0 < 0 || i == 1)
            {
                int deco2;
            ...
            {
                draw_indexed("shadow_deco", dx, dy, deco[l]._0, deco[l]._1);
            }
        }
    }
    else
    {
        ...
        int l2 = (l - 1000) % 16; // check b, d, e and g.
        int i = 0;
        if (l2 == 15)
        {
            // You cannot see the cell (x) and all 4 cells around the cell (b,
            // d, e and g).
            int l3 = (l - 1000) % 256 - 15; // check a, c, f and h.
            // clang-format off
            switch (l3)
            {
            case                  0: i =  0; break;
            case                 16: i =  0; break;
            case            32:      i =  0; break;
            case            32 + 16: i = 17; break; // a h
            case       64:           i =  0; break;
            case       64      + 16: i =  0; break;
            case       64 + 32:      i =  0; break;
            case       64 + 32 + 16: i = 13; break; // a f h
            case 128:                i =  0; break;
            case 128           + 16: i =  0; break;
            case 128      + 32:      i =  0; break;
            case 128      + 32 + 16: i = 15; break; // a c h
            case 128 + 64:           i = 17; break; // c f
            case 128 + 64      + 16: i = 14; break; // a c f
            case 128 + 64 + 32:      i = 16; break; // c f h
            case 128 + 64 + 32 + 16: i =  0; break;
