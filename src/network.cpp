...
label_14001_internal:
    ...
    ++listmax;
    net_read(1);
    if (gdata_next_voting_time > game_data.date.hour + game_data.date.day * 24
...
label_1402_internal:
    ...
    if (p != -1)
    {
        ...
        if (gdata_next_voting_time > game_data.date.hour
        ...
        gdata_next_voting_time = game_data.date.hour + game_data.date.day * 24
            + game_data.date.month * 24 * 30
