...
#include "ui/ui_menu_composite_city.hpp"
...
{
    ui::ui_menu_composite_city(ui::ui_menu_composite_city::index::chart).show();
}

void show_economy_window()
{
    ui::ui_menu_composite_city(ui::ui_menu_composite_city::index::economy)
        .show();
}
