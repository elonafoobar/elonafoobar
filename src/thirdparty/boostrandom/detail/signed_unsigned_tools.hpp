...
#ifndef BOOSTRANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
#define BOOSTRANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
...
{
  typedef typename boostrandom::traits::make_unsigned_or_unbounded<T>::type result_type;
...
#endif // BOOSTRANDOM_DETAIL_SIGNED_UNSIGNED_TOOLS
