...
talk_result_t talk_house_visitor_adventurer()
{
...
talk_result_t talk_house_visitor_trainer()
{
...
talk_result_t talk_house_visitor_townsperson()
{
    listmax = 0;
    buff = i18n::s.get("core.locale.talk.visitor.wanted_to_say_hi", cdata[tc]);
    tc = tc * 1 + 0;
...
talk_result_t talk_house_visitor_beggar()
{
...
talk_result_t talk_house_visitor_punk()
{
    list(0, listmax) = 1;
    listn(0, listmax) = i18n::s.get("core.locale.talk.visitor.choices.yes");
    ++listmax;
...
talk_result_t talk_house_visitor_mysterious_producer()
{
...
talk_result_t talk_house_visitor_merchant()
{
    list(0, listmax) = 0;
    listn(0, listmax) =
...
talk_result_t talk_house_visitor()
{
    ...
    {
    case 13: return talk_house_visitor_adventurer();
    case 2005: return talk_house_visitor_trainer();
    case 2002: return talk_house_visitor_townsperson();
    case 2000: return talk_house_visitor_beggar();
    case 2001: return talk_house_visitor_punk();
    case 2006: return talk_house_visitor_mysterious_producer();
    case 2003: return talk_house_visitor_merchant();
    }
    return talk_result_t::talk_end;
}
