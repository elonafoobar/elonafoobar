...
void gain_skill_experience_healing_and_meditation(int);
void gain_skill_experience_stealth(int);
void gain_skill_experience_weight_lifting(int);
void gain_skill_experience_magic_device(int);
