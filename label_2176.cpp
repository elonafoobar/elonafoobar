        ...
        if (efid < 661)
        {
            ...
            if (f)
            {
                ...
                if (efid == 447)
                {
                    ...
                    {
                        cdata(21, tc) += rnd(3) + 1;
                        if (cdata(21, tc) + 12 > gdata(10))
                        {
                            cdata(21, tc) = gdata(10) - 12;
                        }
                        if (synccheck(tc, -1))
                        {
                            txtef(2);
...
label_2181_internal:
    ...
    case 629:
        ...
        if (stat == 1)
        {
            ...
            gdata(25) += p;
            txt(lang(
                itemname(ci) + u8"を破壊して"s + p + u8"の魔力を抽出した(計"s
                    + gdata(25) + u8")"s,
    ...
    case 1140:
        ...
        if (stat == 1)
        {
            ...
            if (efstatus >= 0)
            {
                ...
                txt(lang(
                    ""s + itemname(ci, 1) + u8"は羽が生えたように軽くなった。"s,
            ...
            else
            {
                ...
                if (inv(15, ci) > 0)
                {
                    inv(15, ci) += limit(inv(15, ci) / 10, 1, 5);
                }
                if (inv(12, ci) > 0)
                {
