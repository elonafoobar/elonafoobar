...
struct item_info
{
    int id;
    int light;
    const char* katakana_name;
    int original_weight;
    const char* original_name_jp;
    const char* original_name_en;
    const char* originalnameref2;
    int image;
    bool has_random_name = false;
};



const item_info item_info_table[] = {
    {
        792,
        0,
        "",
    ...
    },
    {
        ...
        32000,
        u8"花で飾られた柱",
        u8"statue ornamented with flowers",
        "",
        526,
    },
    {
        ...
        32000,
        u8"植物で飾られた柱",
        u8"statue ornamented with plants",
        "",
        525,
    },
    {
...
void label_1277()
{
    ...
    {
        ilight(info.id) = info.light;
        ialphanameref(info.id) = info.katakana_name;
        iorgweight(info.id) = info.original_weight;
        ioriginalnameref(info.id) =
            lang(info.original_name_jp, info.original_name_en);
        ioriginalnameref2(info.id) = info.originalnameref2;
        ipicref(info.id) = info.image;
        irandomname(info.id) = info.has_random_name ? 1 : 0;
    }
