    ...
    food {
        ...
        effect {
            ...
            corpse {
                ...
                insanity = "It tastes really, really strange."
                horse = "A horsemeat! It's nourishing"
                holy_one = "${name(_1)} feel${s(_1)} as ${he(_1)} ${have(_1)} been corrupted."
                at = "You dare to eat @..."
                guard = "Guards hate you."
                fire = "${name(_1)}${his_owned(_1)} body burns up for a second."
                insanity2 = "Sheer madness!"
                cute_one = "${name(_1)}${his_owned(_1)} skin becomes smooth."
                lovely_one = "${name(_1)} feel${s(_1)} love!"
                poisonous_one = "Argh! It's poisonous!"
                troll = "A troll meat. This must be good for your body."
                rotten_one = "Of course, it's rotten! Urgh..."
                strength = "Mighty taste!"
                magic = "${name(_1)} ${is(_1)} magically stimulated."
                insanity3 = "Something is wrong with ${name(_1)}${his_owned(_1)} stomach..."
                calm = "Eating this brings ${name(_1)} inner peace."
                chaos = "${name(_1)} ${is(_1)} shaken by a chaotic power."
                lightning = "${name(_1)}${his_owned(_1)} nerve is damaged."
                cat = "How can you eat a cat!!"
                ether = "Ether corrupts ${name(_1)}${his_owned(_1)} body."
                constitution = "This food is good for your endurance."
                magic2 = "This food is good for your magic."
                strength2 = "This food is good for your strength."
                will = "This food is good for your will power."
                speed = "Wow, ${name(_1)} speed${s(_1)} up!"
