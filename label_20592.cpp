...
label_20591:
    ...
    mainweapon = -1;
    {
        ...
        for (int cnt_end = cnt + (2); cnt < cnt_end; ++cnt) {
            ...
            inv_getheader(p);
            cnt2 = cnt;
            if (invctrl != 1 && invctrl != 5 && invctrl != 13 &&
                invctrl != 14 && invctrl != 18 && invctrl != 20 &&
                invctrl != 23 && invctrl != 25 && invctrl != 27) {
                countequip = 0;
            } else {
                countequip = 1;
            }
            ...
            }
            {
                ...
                for (int cnt_end = cnt + (invrange); cnt < cnt_end; ++cnt) {
                    ...
                    if (inv(3, cnt) == 488) { inv(19, cnt) = 9; }
                    if (inv(3, cnt) == 504) { inv(19, cnt) = 38; }
                    if (inv(3, cnt) >= 800 || inv(3, cnt) < 0) {
                        dialog(u8"Invalid Item Id found. Item No:"s + cnt +
                            u8", Id:"s + inv(3, cnt) +
                    ...
                    if (cnt2 == 0) {
                        if (invctrl == 27) {
                            ...
                            if (invctrl != 11 && invctrl != 22 &&
                                invctrl != 28) {
                                if (inv(5, cnt) != cdata(1, cc) ||
                                    inv(6, cnt) != cdata(2, cc)) {
                                    continue;
                                }
                            }
                        }
                    ...
                    if (inv(21, cnt) == 5) {
                        if (ibit(16, cnt) == 0 || invctrl != 14) {
                            if (invctrl != 1) { continue; }
                        }
                    }
                    if (countequip == 0) {
                        if (inv(18, cnt) != 0) { continue; }
                    }
                    if (inv(18, cnt) != 0) {
                        if (mainweapon == -1) {
                            if (reftype == 10000) { mainweapon = cnt; }
                        }
                    }
                    if (invctrl == 5) {
                    ...
                    if (invctrl == 7) {
                        if (refitem(inv(3, cnt), 2) == 0) { continue; }
                    }
                    if (invctrl == 8) {
                        if (refitem(inv(3, cnt), 4) == 0) { continue; }
                    }
                    if (invctrl == 9) {
                        if (refitem(inv(3, cnt), 3) == 0) { continue; }
                    }
                    if (invctrl == 11) {
                    ...
                    if (invctrl == 11 || invctrl == 12) {
                        ...
                        if (inv(1, cnt) <= 1) { continue; }
                        if (ibit(5, cnt) == 1) { continue; }
                        if (inv(27, cnt) < 0) { continue; }
                        if (inv(4, cnt) == 6) { continue; }
                    }
                    if (invctrl == 13) {
                        if (inv(8, cnt) >= 3) { continue; }
                    }
                    if (invctrl == 14) {
                        if (inv(19, cnt) == 0 &&
                            refitem(inv(3, cnt), 11) == 0 &&
                            ibit(10, cnt) == 0) {
                            continue;
                        }
                    }
                    if (invctrl == 15) {
                        if (reftype != 72000) { continue; }
                    }
                    if (invctrl == 16) {
                        if (reftype != 57000) {
                            continue;
                        } else {
                            if (inv(26, cnt) != 0) { continue; }
                        }
                    }
                    if (invctrl == 17) {
                    ...
                    if (invctrl == 18) {
                        if (inv(3, cidip) == 617) {
                            if (inv(3, cnt) != 342) { continue; }
                        }
                        if (cidip == cnt || inv(3, cnt) == 516) { continue; }
                    }
                    if (invctrl == 19) {
                        if (refitem(inv(3, cnt), 12) == 0) { continue; }
                    }
                    if (invctrl == 20) {
                        if (inv(3, cnt) == 54 || inv(3, cnt) == 55) {
                            continue;
                    ...
                    if (invctrl == 21) {
                        if (calcitemvalue(cnt, 0) * inv(0, cnt) <
                            calcitemvalue(citrade, 0) * inv(0, citrade) / 2 *
                                3) {
                            continue;
                        }
                        if (ibit(9, cnt)) { continue; }
                    }
                    if (invctrl == 23) {
                        if (invctrl(1) == 0) {
                        ...
                        if (invctrl(1) == 3) {
                            if (ibit(4, cnt) == 0) { continue; }
                        }
                        if (invctrl(1) == 4) {
                            if (inv(18, cnt) != 0) { continue; }
                        }
                        if (invctrl(1) == 5) {
                            if (reftype != 56000) { continue; }
                        }
                        if (invctrl(1) == 6) {
                    ...
                    if (invctrl == 24) {
                        if (invctrl(1) == 0) {
                            if (gdata(20) == 36) {
                                ...
                                if (inv(21, cnt) != 4) { continue; }
                            }
                        } else {
                            if (inv(21, cnt) == 4) { continue; }
                        }
                        if (invctrl(1) == 2) {
                            if (inv(3, cnt) != 615) { continue; }
                        }
                        if (reftype == 72000) { continue; }
                        if (invctrl(1) == 3) {
                            if (reftype != 57000) { continue; }
                        }
                    } else {
                        if (inv(21, cnt) == 4) {
                    ...
                    if (invctrl == 26) {
                        if (reftype != 52000 && inv(3, cnt) != 578 &&
                            inv(3, cnt) != 685 && inv(3, cnt) != 699 &&
                            inv(3, cnt) != 772) {
                            continue;
                        }
                        if (inv(3, cnt) == 685) {
                            if (inv(23, cnt) != 0) { continue; }
                        }
                    }
                    if (invctrl == 27) {
                        if (cnt2 == 0) {
                            if (inv(21, cnt) != 1) { continue; }
                        }
                    }
                    list(0, listmax) = cnt;
                    ...
                    if (invctrl == 1 || invctrl == 13) {
                        if (inv(18, cnt) != 0) { list(1, listmax) -= 99999000; }
                    }
                    if (cnt2 == 0) { list(1, listmax) -= 199998000; }
                    if (invctrl == 28) {
    ...
    if (listmax == 0) {
        if (invctrl == 21) {
            txt(lang(itemname(citrade) + u8"に見合う物を所持していない。"s,
        ...
        if (invctrl == 27) {
            if (tc != 0) {
                txt(lang(name(tc) + u8"は盗めるものを所持していない。"s,
                    name(tc) + u8" has nothing to steal."s));
                f = 1;
            } else {
                txt(lang(u8"そこに盗めるものはない。"s,
    ...
    if (returnfromidentify == 0) {
        ...
        if (invctrl == 28) {
            ...
            txtmore();
            txt(lang(u8"(持っているメダル: "s + p + u8"枚)"s,
                u8"(Coins: "s + p + u8")"s));
        }
        if (invctrl == 24) {
            if (invctrl(1) == 0) {
    ...
    gsel(0);
    if (returnfromidentify == 0) { windowshadow = 1; }
...
label_2060_internal:
    if (invsc != 0) {
        ...
        if (f == 0) {
            inv_find(invsc, 0);
            if (stat == -1) {
                txt(lang(u8"そのアイテムは存在しない。"s,
                    u8"The item doesn't exist."s));
            } else {
                txtnew();
                txt(lang(u8"その行為は、ワールドマップにいる間はできない。"s,
...
label_2061_internal:
    ...
    if (invctrl == 11 || invctrl == 12) { s = lang(u8"値段"s, u8"Price"s); }
    if (invctrl == 28) { s = lang(u8"メダル"s, u8"Medal"s); }
    display_topic(lang(u8"アイテムの名称"s, u8"Name"s), wx + 28, wy + 30);
    display_topic(s, wx + 526, wy + 30);
    if (showresist) {
        pos(wx + 300, wy + 40);
        color(0, 0, 0);
        mes(lang(u8"火 冷 雷 闇 幻 毒 獄 音 神 沌 魔"s,
    ...
    cs_listbk();
    {
        ...
        for (int cnt_end = cnt + (pagesize); cnt < cnt_end; ++cnt) {
            ...
            if (invctrl != 3 && invctrl != 11 && invctrl != 22 &&
                ...
                if (p >= 5080) { s += lang(u8"(足元)"s, u8" (Ground)"s); }
            }
            {
                int cnt = 0;
            ...
            if (p(1) == 528) {
                ...
                pos(0, 1008);
                gzoom(22, 20, 5, chipc(0, inv(22, p)) + 8,
                    chipc(1, inv(22, p)) + 4 +
                ...
                if (p(1) == 531) {
                    ...
                    gcopy(5, chipc(0, inv(22, p)) + 8, chipc(1, inv(22, p)) + 2,
                        chipc(2, inv(22, p)) - 16, chipc(3, inv(22, p)) - 8);
                    gmode(4 - 1, -1, 150);
                    color(0, 0, 0);
                    pos(0, 960 + (chipc(3, inv(22, p)) == inf_tiles) * 48);
                    gcopy(1, 144, 768 + (chipc(3, inv(22, p)) > inf_tiles) * 48,
                        inf_tiles,
                        chipc(3, inv(22, p)) +
                    ...
                    pos(0, 960);
                    gcopy(1, chipi(0, p(1)), chipi(1, p(1)), chipi(2, p(1)),
                        chipi(3, p(1)));
                    gfini(chipi(2, p(1)), chipi(3, p(1)));
                    gfdec2(c_col(0, inv(22, p)), c_col(1, inv(22, p)),
                        c_col(2, inv(22, p)));
                    gsel(selcur);
                }
            }
            ...
            grotate(1, 0, 960, 0, chipi(2, p(1)) * inf_tiles / chipi(3, p(1)),
                inf_tiles);
            if (inv(18, p) != 0) {
    ...
    label_2062_internal:
        cargocheck();
        if (stat == 0) { goto label_2061_internal; }
        if (invctrl == 1) {
            label_2068();
            goto label_20591;
        }
        if (invctrl == 2) {
            ...
            if (inv(0, ci) > 1) {
                txt(lang(itemname(ci, 1) + u8"をいくつ落とす？ (1〜"s +
                        inv(0, ci) + u8") "s,
                    u8"How many? (1 to "s + inv(0, ci) + u8")"s));
                ...
                if (in == 0 || rtval == -1) { goto label_2060_internal; }
            } else {
                in = 1;
            }
            savecycle();
        ...
        if (invctrl == 3 || invctrl == 11 || invctrl == 12 || invctrl == 22 ||
            ...
            if (invctrl == 24) {
                ...
                if (invctrl(1) == 5) {
                    if (inv(7, ci) >= efp * 100) {
                        snd(27);
                        txt(lang(u8"重さが"s + cnvweight(efp * 100) +
                                u8"以上の物は入らない。"s,
            ...
            if (inv(21, ci) > 0 && inv(21, ci) < 3) {
                ...
                if (inv(21, ci) == 1) {
                    txt(lang(u8"それはあなたの物ではない。"s,
                            u8"It's not your property."s),
                        lang(u8"盗むなんてとんでもない。"s,
            ...
            if (mode == 6 && inv(0, ci) > 1 && invctrl != 22) {
                if (invctrl == 11) {
                    txt(lang(itemname(ci, 1) + u8"をいくつ買う？ (1〜"s +
                            inv(0, ci) + u8") "s,
                        u8"How many? (1 to "s + inv(0, ci) + u8")"s));
                }
                if (invctrl == 12) {
                    txt(lang(itemname(ci, 1) + u8"をいくつ売る？ (1〜"s +
                            inv(0, ci) + u8") "s,
                        u8"How many? (1 to "s + inv(0, ci) + u8")"s));
                }
            ...
            if (mode == 6 && invctrl != 22 && invctrl != 24) {
                if (invctrl == 11) {
                    txt(lang(itemname(ci, in) + u8"を "s +
                            in * calcitemvalue(ci, 0) + u8" gp で買う？"s,
                ...
                if (invctrl == 12) {
                    txt(lang(itemname(ci, in) + u8"を "s +
                            in * calcitemvalue(ci, 1) + u8" gp で売る？"s,
                ...
                if (invctrl == 11) {
                    if (calcitemvalue(ci, 0) * in > cdata(30, 0)) {
                        screenupdate = -1;
                        label_1419();
                        txt(lang(u8"あなたは財布を開いてがっかりした…"s,
                                u8"You check your wallet and shake your head."s),
                            lang(u8"もっと稼がないと買えない！"s,
            ...
            if (invctrl == 22) {
                if (invctrl(1) == 1) {
                    --gdata(97);
                    if (invctrl(1) == 1) {
                        txt(lang(u8"残り"s + gdata(97) +
                                u8"個分のアイテムの相続権を持っている。"s,
                            u8"You can claim "s + gdata(97) +
                                u8" more heirloom"s + _s2(gdata(97)) + u8"."s));
                    }
                }
                if (invctrl(1) == 4) {
                    ++gdata(812);
        ...
        if (invctrl == 6) {
            ...
            snd(13);
            txtnew();
            txt(lang(itemname(ci) + u8"を装備した。"s,
                u8"You equip "s + itemname(ci) + u8"."s));
            gdata(808) = 1;
            if (inv(17, ci) == -1) {
                txt(lang(name(cc) + u8"は急に寒気がしてふるえた。"s,
                    u8"You suddenly feel a chill and shudder."s));
            }
            if (inv(17, ci) == -2) {
                txt(lang(name(cc) + u8"は破滅への道を歩み始めた。"s,
                    u8"You are now one step closer to doom."s));
            }
            if (inv(17, ci) == 1) {
                txt(lang(name(cc) + u8"は何かに見守られている感じがした。"s,
                    u8"You feel as someone is watching you intently."s));
            }
            if (cdata(body, cc) / 10000 == 5) { label_2049(); }
            menucycle = 1;
            label_2050();
            stat = 0;
            return stat;
        ...
        if (invctrl == 10) {
            ...
            ti = inv_getfreeid(tc);
            if (cdata(251, tc)) {
                txt(lang(name(tc) + u8"は眠っている。"s,
                    name(tc) + u8" "s + is(tc) + u8" sleeping."s));
                snd(27);
                goto label_2060_internal;
            }
            if (ti == -1) {
                txt(lang(name(tc) + u8"はこれ以上持てない。"s,
            ...
            if (inv(3, ci) == 729) {
                txt(lang(u8"あなたは"s + name(tc) + u8"に"s + itemname(ci, 1) +
                        u8"をプレゼントした。"s,
            ...
            if (cdata(27, tc) == 265) { p *= 5; }
            if (inv_weight(tc) + inv(7, ci) > p) { f = 1; }
            if (cdata(27, tc) != 265) {
                if (reftype == 60000) { f = 2; }
                if (reftype == 64000) { f = 3; }
            }
            if (inv(7, ci) < 0) { f = 4; }
            if (f) {
                s(0) = "";
            ...
            if (cdata(9, tc) == 10) {
                ...
                if (inv(8, ci) < 2) {
                    snd(27);
                    txt(lang(u8"「そんな得体の知れないものはいらない"s + _yo() +
                            u8"」"s,
                ...
                if (inv(17, ci) <= -1) {
                    snd(27);
                    txt(lang(u8"「それ、呪われてい"s + _ru() + u8"」"s,
                ...
                if (reftype == 53000) {
                    ...
                    if (inv(3, ci) == 16 || inv(3, ci) == 245) { f = 0; }
                }
                if (reftype == 52000) {
                    f = 1;
                    ...
                    if (instr(filter_item(inv(3, ci)), 0, u8"/nogive/"s) !=
                        -1) {
                        f = 0;
                    }
                    if (cbit(978, tc)) {
                        if (inv(3, ci) == 262 || inv(3, ci) == 519 ||
                            inv(3, ci) == 392) {
                            f = 1;
                            txt(lang(
            ...
            if (f) {
                ...
                if (inv(3, ci) == 620) {
                    txtmore();
                    txtef(8);
                    txt(lang(name(tc) + u8"は激怒して"s + itemname(ci, 1) +
                            u8"を叩き割った。"s,
                        name(tc) + u8" throws it on the ground angrily."s));
                    snd(47);
                    txtmore();
                    txtef(9);
                    txt(lang(name(tc) + u8"「サイテー！！」"s,
                            cnvtalk(u8"You scum!"s)),
                        lang(name(tc) + u8"「このヘンタイ！」"s,
                            cnvtalk(u8"What are you trying to do!"s)),
                        lang(name(tc) + u8"「ガード！ガード！ガード！」"s,
                ...
                label_2663();
                label_2666();
                if (tc < 16) { create_pcpic(tc, 1); }
                r1 = tc;
                label_1477();
                label_1521();
                if (invally == 1) { goto label_20591; }
                label_1419();
                label_2742();
                stat = 0;
                return stat;
        ...
        if (invctrl == 13) {
            ...
            if (stat == 0) {
                ...
                if (stat < 3) {
                    txt(lang(u8"それは"s + itemname(ci, inv(0, ci)) +
                    ...
                    txt(lang(u8"それは"s + itemname(ci, inv(0, ci)) +
                            u8"だと完全に判明した。"s,
                        u8"The item is fully identified as "s +
                            itemname(ci, 1) + u8"."s));
                }
            }
            item_stack(0, ci, 1);
        ...
        if (invctrl == 21) {
            ...
            rc = tc;
            ci = citrade;
            if (cdata(12, rc) == ci) { cdata(12, rc) = 0; }
            label_2666();
            if (tc >= 16) { label_2668(); }
            label_2665();
            r1 = tc;
        ...
        if (invctrl == 24) {
            if (invctrl(1) == 0) {
                ...
                if (gdata(20) == 36) {
                    ...
                    if (gdata(266) <= 0) { gdata(266) = 0; }
                    txtef(2);
                    txt(lang(itemname(ci) + u8"を納入した"s,
                            u8"You deliver "s + itemname(ci) + u8". "s) +
                        u8"("s + (inv(25, ci) + 1) * inv(0, ci) +
                        u8" Guild Point)"s);
                    if (gdata(266) == 0) {
                        snd(51);
                        txtef(2);
                        txt(lang(u8"ノルマを達成した！"s,
                    ...
                    txt(lang(itemname(ci) + u8"を納入した。"s,
                            u8"You deliver"s + itemname(ci) + u8"."s) +
                        u8" +"s + cnvweight(inv(7, ci) * inv(0, ci)) +
            ...
            if (invctrl(1) == 2) {
                ...
                snd(12);
                txtef(2);
                txt(lang(itemname(ci) + u8"を支払った。"s,
        ...
        if (invctrl == 25) {
            ...
            txt(lang(itemname(ci, in) + u8"を受け取った。"s,
    ...
    if (key == key_mode2) {
        if (invctrl == 1) {
            ...
            if (ibit(13, ci) == 0) {
                ibitmod(13, ci, 1);
                txt(lang(itemname(ci) + u8"を大事なものに指定した。"s,
                    u8"You set "s + itemname(ci) + u8" as no-drop."s));
            } else {
                ibitmod(13, ci, 0);
                txt(lang(itemname(ci) + u8"はもう大事なものではない。"s,
                    itemname(ci) + u8" is no longer set as no-drop."s));
            }
        }
        if (invctrl == 2) {
            if (dropcontinue == 0) {
                txt(lang(u8"続けてアイテムを置くことができる。"s,
        ...
        if (invctrl == 22) {
            if (invctrl(1) == 0) {
                if (listmax > 0) {
                    ...
                    val(3) = 1;
                    label_2131();
                    if (rtval != 0) { goto label_2060_internal; }
                }
            }
        }
        cc = 0;
    ...
    if (invctrl == 5 || invctrl == 7 || invctrl == 8 || invctrl == 9 ||
        ...
        if (key == u8"sc"s) {
            ...
            }
            {
                int cnt = 0;
                for (int cnt_end = cnt + (20); cnt < cnt_end; ++cnt) {
                    if (gdata(40 + cnt) == p) { gdata(40 + cnt) = 0; }
                }
            }
            gdata(40 + sc) = p;
            txt(lang(u8"{"s + sc + u8"}キーにショートカットを割り当てた。"s,
