locale {
    god {
        ...
        lulwy {
            ...
            summon = "\"You dare to call my name?\"",
        }
        itzpalt {
        ...
        ehekatl {
            ...
            short_name = "ehekatl",
            description = "Ehekatl is a goddess of luck. Those faithful to Ehekatl are<br>really lucky.<p>",
        ...
        opatos {
            ...
            short_name = "opatos",
            description = "Opatos is a god of earth. Those faithful to Opatos have massive<br>strength and defense.<p>",
        ...
        jure {
            ...
            short_name = "jure",
            description = "Jure is a god of healing. Those faithful to Jure can heal wounds.<p>",
            offering = "Corpses/Ores",
        ...
        kumiromi {
            ...
            short_name = "kumiromi",
            description = "Kumiromi is a god of harvest. Those faithful to Kumiromi receive<br>the blessings of nature.<p>",
