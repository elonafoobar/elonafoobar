        ...
        text {
            core {
                ...
                ehekatl {
                    ...
                    short_name = "ehekatl",
                    text = "Ehekatl is a goddess of luck. Those faithful to Ehekatl are<br>really lucky.<p>",
                ...
                opatos {
                    ...
                    short_name = "opatos",
                    text = "Opatos is a god of earth. Those faithful to Opatos have massive<br>strength and defense.<p>",
                ...
                jure {
                    ...
                    short_name = "jure",
                    text = "Jure is a god of healing. Those faithful to Jure can heal wounds.<p>",
                    offering = "Corpses/Ores",
                ...
                kumiromi {
                    ...
                    short_name = "kumiromi",
                    text = "Kumiromi is a god of harvest. Those faithful to Kumiromi receive<br>the blessings of nature.<p>",
