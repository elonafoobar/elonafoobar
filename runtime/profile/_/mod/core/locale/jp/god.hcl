locale {
    god {
        mani {
            name = "機械のマニ",
            short_name = "マニ",
            description = "マニは機械仕掛けの神です。マニを信仰した者は、機械や罠に対する膨大な知識を得、またそれらを効果的に利用する術を知ります。<p>",
            offering = "死体 / 銃器 / 機械",
        ...
        lulwy {
            name = "風のルルウィ",
            short_name = "ルルウィ",
            description = "ルルウィは風を司る女神です。ルルウィを信仰した者は、風の恩恵を受け素早く動くことが可能になります。<p>",
            offering = "死体 / 弓",
            ...
            summon = "「アタシを呼びつけるとは生意気ね。」",
        }
        itzpalt {
            name = "元素のイツパロトル",
            short_name = "イツパロトル",
            description = "イツパロトルは元素を司る神です。イツパロトルを信仰した者は、魔力を大気から吸収し、元素に対する保護を受けることができます。<p>",
            offering = "死体 / 杖",
        ...
        ehekatl {
            name = "幸運のエヘカトル",
            short_name = "エヘカトル",
            description = "エヘカトルは幸運の女神です。エヘカトルを信仰した者は、運を味方につけます。<p>",
            offering = "死体 / 魚",
        ...
        opatos {
            name = "地のオパートス",
            short_name = "オパートス",
            description = "オパートスは大地の神です。オパートスを信仰した者は、高い防御力と破壊力を身につけます。<p>",
            offering = "死体 / 鉱石",
        ...
        jure {
            name = "癒しのジュア",
            short_name = "ジュア",
            description = "ジュアは癒しの女神です。ジュアを信仰した者は、傷ついた身体を癒すことができます。<p>",
            offering = "死体 / 鉱石",
        ...
        kumiromi {
            name = "収穫のクミロミ",
            short_name = "クミロミ",
            description = "クミロミは収穫の神です。クミロミを信仰した者は、大地の恵みを収穫し、それを加工する術を知ります。<p>",
            offering = "死体 / 野菜 / 種",
