...
local function something_is_put_on_the_ground()
...
local lomias = {
   ...
   nodes = {
      ...
      tutorial_3 = {
         text = {
            function()
               something_is_put_on_the_ground()
      ...
      tutorial_6 = function(t)
         local putit = Chara.find("core.putit")
         if putit ~= nil then
            t:say("tutorial.combat.not_finished", "__BYE__")
            return "__END__"
         end
         t:say("tutorial.combat.finished")
      ...
      get_out = function(t)
         local larnneire = Chara.find("core.larnneire")
         if larnneire == nil then
            local lomias = Chara.find("core.lomias")
      ...
      get_out_1 = {
         ...
         on_finish = function()
            Chara.find("core.larnneire"):vanquish()
            Chara.find("core.lomias"):vanquish()
