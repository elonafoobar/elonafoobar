    ...
    talk {
        unique {
            ...
            loyter {
                ...
                quest {
                    dialog {
                        _0 = "Hey you! Hold up! I've seen your face before punk... ${_1}... Ah yes... I remember now. You've been making quite a name for yourself throughout Tyris, haven't you?"
            ...
            xabi {
                ...
                early {
                    ...
                    _1 = "I see... then what we feared has indeed come to pass. If evil has set its sights on the artifact hidden within the depths of Lesimas, then for the honor of our King we are bound to stop it... You must be tired, ${_1}. Give me a moment to prepare appropriate compensation for your efforts today."
                }
            }
            ...
            erystia {
                ...
                stones {
                    dialog {
                        _0 = "I've been waiting for you to return, ${_1}. I hope that Karam is... no, I can tell just by looking at you. Then our rescue attempt was too little too late."
                ...
                investigation {
                    dialog = "${_1}, how's your investigation going? Ask anything you'd like to know."
                    ...
                    mission {
                        ...
                        stones {
                            ...
                            _1 = "Your duty will be to penetrate into Lesimas and make contact with <Karam>. In the last report we received from him, he told us he was on the 16th floor. If you can find him, perhaps we can get this excavation back on track. Godspeed, ${_1}, find out what happened to <Karam>."
                        }
                    }
                ...
                introduction {
                    ...
                    pledge_strength {
                        dialog {
                            ...
                            _3 = "Your duty will be to penetrate into Lesimas and make contact with <Karam>. In the last report we received from him, he told us he was on the 16th floor. If you can find him, perhaps we can get this excavation back on track. Godspeed, ${_1}, find out what happened to <Karam>."
                        }
            ...
            miral {
                ...
                upgrade_cart {
                    dialog = "Upgrade your cart? It's not something I get excited about but if you can give me ${_1} small medals, I'll think about it."
                    ...
                    give {
                        dialog = "Here you are."
                        limit_increased = "Your cart's weight limit has increased by ${_1}."
                    }
            ...
            pael {
                ...
                progress {
                    ...
                    _2 = "Ah, hi ${_1}. Thanks to you Mommy's been getting better! But... it still looks like she needs more time before she's really healthy."
                    ...
                    _4 = "${_1}! It's mommy... something's wrong! Suddenly she started acting strange and... now her body is changing and... oh gods..."
                    _5 = "Mommy! Mommy are you okay? Mommy?"
                    _6 = "${_1}, mommy has something to say to you."
                }
            }
            ...
            paels_mom {
                ...
                progress {
                    last {
                        _0 = "${_1}, I'm sorry you have to see me this way... please don't turn away... don't run. It seems my disease has already progressed too far... my twisted and hideous body... I can never return to normal... the disease is too advanced now."
                    ...
                    end_life {
                        dialog {
                            _0 = "${_1}, I have... I have one final request. Take this knife and... *weep*. If Pael's friends saw me like this, they'd run in fear and treat her with fear and suspicion. As long as she can be happy, I..."
                    ...
                    late = "It's good to see you, ${_1}. Hmm? You say I look happy? Hehe, just before you arrived Pael made a snowman outside. She said she made it with her friends. I haven't seen her smile like that since her father died. When I see that snowman through the window, I feel a joy I cannot describe to you."
            ...
            gilbert {
                ...
                quest {
                    dialog {
                        _0 = "By Opatos! You are the famous ${_1}, are you not? I have a favor I'd like to ask of someone like you. "
            ...
            renton {
                ...
                quest {
                    ...
                    brought = "You've brought ${_1} book${s(_1)}, just for my sake? You have my thanks. If I recall correctly, there are four volumes in the series. If you can find all four for me I'll find some way to thank you. "
            ...
            lexus {
                ...
                member {
                    dialog = "Welcome to the Mages Guild, ${_1} ${_2}... Please come in."
                    choices {
                        new_quota = "Do you have any tasks for me?"
                        report_quota = "About my task."
                    }

                    new_quota = "Sure, there're plenty of tasks for you. For now, collect the ancient books and decrypt them. When you gather ${_1} guild points, we will think about your promotion."
                    report_quota {
            ...
            abyss {
                ...
                member {
                    ...
                    dialog = "Welcome to the Thieves Guild, ${_1} ${_2}... Please come in."

                    new_quota = "Alright. The Thieves Guild wants you to put stolen goods into circulation. Steal some goods and sell them to any vendors. When the sum of your earning reaches ${_1} gold pieces, we will think about your promotion."
                }
            }
            ...
            doria {
                nonmember {
                    ...
                    want_to_join {
                        ...
                        _1 = "The task given to you is this. Find and slay ${_1} ${_2}. When you complete this, talk to me again."
                    }

                    quota = "You still need to slay ${_1} more ${_2}."
                ...
                member {
                    # TODO much duplication
                    dialog = "Welcome to the Fighters Guild, ${_1} ${_2}... Please come in."

                    new_quota = "There's a task for you. Go find and slay ${_1} ${_2}. Then we will think about your promotion."
                }
            }
