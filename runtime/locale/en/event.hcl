    ...
    event {
        ...
        popup {
            ...
            _15 {
                ...
                scream = "${name(_1)} screams, \"Ahhhhhhh!\""
            }
            ...
            _16 {
                ...
                you_pick_up = "You pick up ${_1} gold pieces."
            }
            ...
            marriage {
                title = "Marriage"
                text = "At last, you and ${name(_1)} are united in marriage! After the wedding ceremony, you receive some gifts."
