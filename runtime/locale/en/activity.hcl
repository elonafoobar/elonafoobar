locale {
    activity {
        ...
        eat {
            start {
                normal = "${name(_1)} start${s(_1)} to eat ${itemname(_1, 1)}."
                in_secret = "${name(_1)} start${s(_1)} to eat ${itemname(_1, 1)} in secret."

                mammoth = "\"Let's eatammoth.\""
            }

            finish = "${name(_1)} ${have(_1)} finished eating ${itemname(_1, 1)}."
        }
        ...
        material {
            ...
            # TODO: The text logic for JP is completely different.
            get = "You get ${_1}. "
            get2 = "You ${_1} ${_2}."
