locale {
    item {
        ...
        item_someone_equips_turns_to_dust = "${_1} ${name(_3)} equip${s(_3)} turn${s(_2)} to dust."
        someones_item_turns_to_dust = "${name(_3)}${his_owned(_3)} ${_1} turn${s(_2)} to dust."
        item_on_the_ground_turns_to_dust = "${_1} on the ground turn${s(_2)} to dust."
        ...
        someones_item_breaks_to_pieces = "${name(_3)}${his_owned(_3)} ${_1} break${s(_2)} to pieces."
        item_on_the_ground_breaks_to_pieces = "${_1} on the ground break${s(_2)} to pieces."
