        ...
        journal {
            ...
            main {
                ...
                progress {
                    ...
                    _2 = "Eristia will have some tasks for me if I want to work for Palmia. She's in the library of the castle."
                    _3 = "Eristia asked to look for an adventurer called Karam in the dungeon of Lesimas. He was on the 16th level of the dungeon the last time he sent a report. I may have to go deeper if I am to find him."
                    _4 = "I need to bring information Karam gave me to Eristia at once."
            ...
            sub {
                ...
                ambitious_scientist {
                    ...
                    progress {
                        _0 = "Icolle of Port Kapul asked me to bring 5 filled monster balls. I still need to bring him ${_1} of them."
                    }
                }
                ...
                joining_mages_guild {
                    ...
                    progress {
                        _0 = "To join the Mages Guild, I need to gather ${_1} more guild points and talk to the guild guard in Lumiest. I can earn the guild points by collecting ancients books, decrypt them, and put them into the delivery box near the guild guard."
                    }
                }
                ...
                joining_fighters_guild {
                    ...
                    progress {
                        _0 = "To join the Fighters Guild, I need to slay ${_1} more ${_2} and talk to the guild guard in Port Kapul."
                    }
                }
                ...
                quota_mages_guild {
                    ...
                    progress {
                        _0 = "To raise the rank in the Mages Guild, you need to gather ${_1} more guild points and talk to the guard in Lumiest. I can earn the guild points by collecting ancients books, decrypt them, and put them into the delivery box near the guild guard."
                    }
                }
                ...
                quota_fighters_guild {
                    ...
                    progress {
                        _0 = "To raise the rank in the Fighters Guild, I need to slay ${_1} more ${_2} and talk to the guild guard in Port Kapul."
                    }
                }
                ...
                quota_thieves_guild {
                    ...
                    progress {
                        _0 = "To raise the rank in the Thieves Guild, I need to sell stolen goods worth total of ${_1} gold pieces and talk to the guild guard in Derphy."
                    }
                }
