    ...
    trait {
        ...
        _202 {
            ...
            negative {
                gain ="あなたの顔はただれた。"
                levels {
                    _0 ="あなたの顔はただれている[魅力${_1}]"
                    _1 ="あなたの顔中に蕁麻疹が出ている[魅力[CHR${_1}]"
                    _2 ="あなたの顔は崩れかけている[魅力[CHR${_1}]"
                }
            }
        }
        _203 {
            ...
            negative {
                gain ="あなたの足の裏は蹄に変形した。"
                levels {
                    _0 ="あなたの足の裏は蹄になっている[足装備不可 速度+${_1}]"
                }
            }
        }
        _204 {
        ...
        _205 {
            ...
            negative {
                gain ="あなたの背中に羽が生えた。"
                levels {
                    _0 ="あなたの背中には羽がある[背中装備不可 重量-20% 速度+${_1}]"
                }
            }
        }
        _206 {
            ...
            negative {
                gain ="あなたの首は太くなった。"
                levels {
                    _0 ="あなたの首はもの凄く太い[首装備不可 魅力${_1} PV+${_2}]"
                }
            }
        }
        _207 {
            ...
            negative {
                gain ="あなたは憎しみに支配された。"
                levels {
                    _0 ="あなたは殺戮に飢えている[DV${_1} ダメージ修正+${_2}]"
                }
            }
        }
        _208 {
            ...
            negative {
                gain ="あなたの頭は巨大化した。"
                levels {
                    _0 ="あなたの頭は巨大化している[耐久${_1} 器用${_2} 習得+${_3} 意思+${_4}]"
                }
            }
        }
        _209 {
        ...
        _213 {
            ...
            negative {
                gain ="あなたの皮膚は甲殻で覆われた。"
                levels {
                    _0 ="あなたは重い甲殻で覆われている[PV+${_1} 速度${_2}]"
                }
            }
        }
        _214 {
