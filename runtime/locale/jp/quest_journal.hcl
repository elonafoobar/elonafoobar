        ...
        journal {
            ...
            sub {
                ...
                ambitious_scientist {
                    ...
                    progress {
                        _0 = "カプールのイコールに、実験用の生物5体の捕獲を頼まれた。依頼品、モンスターボールに捕獲したものでなくてはならない。あと${_1}個の捕獲済みモンスターボールを届ける必要がある。"
                    }
                }
                ...
                joining_mages_guild {
                    ...
                    progress {
                        _0 = "魔術士ギルドに加入するには、ルミエストのメイジギルドの納入箱に、解読済みの古書物を納入し、ギルドポイントを貯めた後、ギルドの番人に話しかけなければならない。審査をクリアするには、あと${_1}ギルドポイントを獲得する必要がある。"
                    }
                }
                ...
                joining_fighters_guild {
                    ...
                    progress {
                        _0 = "戦士ギルドに加入するには、${_2}をあと${_1}匹討伐してから、カプールのギルドの番人に話しかける必要がある。"
                    }
                }
                ...
                quota_mages_guild {
                    ...
                    progress {
                        _0 = "魔術士ギルドのランクを上げるためには、ルミエストのメイジギルドの納入箱に、解読済みの古書物を納入し、ギルドポイントを貯めた後、ギルドの番人に話しかけなければならない。ランク上昇のためには、あと${_1}ギルドポイントを獲得する必要がある。"
                    }
                }
                ...
                quota_fighters_guild {
                    ...
                    progress {
                        _0 = "戦士ギルドのランクを上げるためには、${_2}をあと${_1}匹討伐してから、カプールのギルドの番人に話しかける必要がある。"
                    }
                }
                ...
                quota_thieves_guild {
                    ...
                    progress {
                        _0 = "盗賊ギルドのランクを上げるためには、あと金貨${_1}枚分の盗品を売りさばき、ダルフィのギルドの番人に話しかける必要がある。"
                    }
                }
