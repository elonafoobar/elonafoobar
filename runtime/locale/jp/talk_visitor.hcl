    ...
    talk {
        visitor {
            ...
            adventurer {
                ...
                conversation {
                    dialog = "やあ。特に用はない${ga(_1, 3)}、なんだか暇を持てましていたら、${kimi(_1, 3)}と話がしたくなって${na(_1, 3)}、寄ってみた${nda(_1)}"
            ...
            beggar {
                no_money ="パンを買う金さえない${nda(_1)}恵んで${kure(_1, 3)}、おねがい${da(_1, 2)}"
            ...
            punk {
                are_you_ready ="フッ。よく逃げ出さずに戻ってきた${na(_1)}準備はいいか。"
                hump ="ふん！"
            }
