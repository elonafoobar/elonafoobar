        ...
        visitor {
            ...
            adventurer {
                ...
                train {
                    ...
                    learn {
                        dialog = "${_1}のスキルを、友達価格の${_2} platで教えてあげてもいい${ga(_3, 3)}どう${kana(_3, 1)}"
                        after ="新しい技術をどうやら習得できたようだ${na(_1)}"
                    }

                    train {
                        dialog = "${_1}のスキルを、友達価格の${_2} platで訓練してもいい${ga(_3, 3)}どう${kana(_3, 1)}"
            ...
            trainer {
                ...
                dialog {
                    ...
                    nonmember = "鍛えている${kana(_2, 2)}冒険者として生き残るには、日ごろの鍛錬が大切${da(_2, 2)}わずかプラチナ${_1}枚で、潜在能力を伸ばす特別な訓練を施してあげる${yo(_2, 2)}"
                }
