locale {
    wish {
        ...
        something_appears_from_nowhere = "足元に${itemname(_1)}が転がってきた。"
        you_learn_skill = "${_1}の技術を会得した！"
        your_skill_improves = "${_1}が上昇した！"

        wish_gold = "金貨が降ってきた！"
        wish_platinum = "プラチナ硬貨が降ってきた！"
        wish_small_medal = "小さなメダルが降ってきた！"
        wish_sex = "${name(_1)}は${_2}になった！ …もう後戻りはできないわよ。"
        ...
        wish_alias {
            ...
            new_alias = "あなたの新しい異名は「${_1}」。満足したかしら？"
