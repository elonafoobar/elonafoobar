...
local function eat_message(eater, locale_id, color)
   local locale_key = "elona.food.effect.corpse." .. locale_id
...
function eating_effect.horse(eater)
   ...
   eater:gain_skill_exp("elona.attribute_constitution", 100)
end
...
function eating_effect.putit(eater)
   ...
   eater:gain_skill_exp("elona.attribute_charisma", 150)
end

function eating_effect.cupid_of_love(eater)
   eat_message(eater, "cupid_of_love", Enums.Color.Green)
   eater:gain_skill_exp("elona.attribute_charisma", 400)
end
...
function eating_effect.troll(eater)
   ...
   eater:gain_skill_exp("elona.healing", 200)
end
...
function eating_effect.beetle(eater)
   ...
   eater:gain_skill_exp("elona.attribute_strength", 250)
end

function eating_effect.mandrake(eater)
   eat_message(eater, "mandrake", Enums.Color.Green)
   eater:gain_skill_exp("elona.meditation", 500)
end
...
local function eating_effect_giant(amount)
   return function(eater)
      ...
      eater:gain_skill_exp("elona.attribute_constitution", amount)
   end
end
...
function eating_effect.imp(eater)
   ...
   eater:gain_skill_exp("elona.attribute_magic", 500)
end

function eating_effect.hand(eater)
   eat_message(eater, "strength", Enums.Color.Green)
   eater:gain_skill_exp("elona.attribute_strength", 400)
end
...
local function eating_effect_ghost(amount)
   return function(eater)
      ...
      eater:gain_skill_exp("elona.attribute_will", amount);
   end
end
...
function eating_effect.quickling(eater)
   ...
   local current = eater:get_skill("elona.attribute_speed").current_level
   local amount = math.clamp(2500 - current * current // 10, 20, 2500)
   eater:gain_skill_exp("elona.attribute_speed", amount);
end
