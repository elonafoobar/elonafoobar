...
data:add_multi(
   "core.map",
   {
      ...
      player_owned {
         ...
         appearance = 153,
         is_indoor = true,
         deed = "elona.deed_of_storage_house",
      },
      player_owned {
         id = "ranch",
         legacy_id = 31,
