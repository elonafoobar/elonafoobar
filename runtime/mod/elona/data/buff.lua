...
local function get_description(self, power)
   return I18N.get_enum_property("elona.buff", "description", self.legacy_id, self._effect(power))
end
   ...
   "core.buff",
   {
      ...
      },
      {
         ...
         on_refresh = function(_self, args)
            mod_skill_level(args, "elona.healing", 40)
         end,
         _effect = function(_power)
            return 0
         end,
      ...
      },
      {
         ...
         on_refresh = function(_self, args)
            mod_skill_level(args, "elona.element_fire", 100)
            mod_skill_level(args, "elona.element_cold", 100)
            mod_skill_level(args, "elona.element_lightning", 100)
         end,
         _effect = function(_power)
            return 0
         end,
      ...
      },
      {
         ...
         on_refresh = function(self, args)
            mod_skill_level(args, "elona.attribute_speed", self._effect(args.power))
         end,
         _effect = function(power)
      ...
      },
      {
         ...
         on_refresh = function(self, args)
            args.chara:get_skill("elona.attribute_speed").current_level =
               args.chara:get_skill("elona.attribute_speed").current_level - self._effect(args.power)
         end,
         _effect = function(power)
      ...
      },
      {
         ...
         on_refresh = function(self, args)
            mod_skill_level(args, "elona.attribute_strength", self._effect(args.power))
            mod_skill_level(args, "elona.attribute_dexterity", self._effect(args.power))
            args.chara:heal_ailment("Fear", 0)
      ...
      },
      {
         ...
         on_refresh = function(_self, args)
            mod_skill_level_clamp(args, "elona.element_fire", -100)
            mod_skill_level_clamp(args, "elona.element_cold", -100)
            mod_skill_level_clamp(args, "elona.element_lightning", -100)
         end,
         _effect = function(_power)
            return 0
         end,
      ...
      },
      {
         ...
         on_refresh = function(_self, args)
            mod_skill_level_clamp(args, "elona.element_nerve", -100)
            mod_skill_level_clamp(args, "elona.element_mind", -100)
         end,
         _effect = function(_power)
            return 0
         end,
      ...
      },
      {
         ...
         on_refresh = function(self, args)
            ...
            mod_skill_level(args, "elona.attribute_learning", a)
            mod_skill_level(args, "elona.attribute_magic", a)
            mod_skill_level(args, "elona.literacy", b)
         end,
         _effect = function(power)
      ...
      },
      {
         ...
         on_refresh = function(self, args)
            mod_skill_level(args, "elona.attribute_speed", self._effect(args.power))
            args.chara:get_skill("elona.attribute_strength").current_level =
               args.chara:get_skill("elona.attribute_strength").current_level * 150 // 100 + 10
            args.chara:get_skill("elona.attribute_dexterity").current_level =
               args.chara:get_skill("elona.attribute_dexterity").current_level * 150 // 100 + 10
            mod_skill_level(args, "elona.healing", 50)
      ...
      },
      {
         ...
         on_refresh = function(self, args)
            mod_skill_level(args, "elona.attribute_luck", self._effect(args.power))
         end,
         _effect = function(power)
            return power
         end,
