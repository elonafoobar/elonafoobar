...
return {
   ...
   nodes = {
      ...
      tutorial_3 = {
         text = {
            function()
               ...
               local scroll = Item.create(Chara.player().position, "elona.scroll_of_identify", 0)
      ...
      tutorial_6 = function()
         local putit = Chara.find("elona.putit", "Others")
         if putit ~= nil then
      ...
      tutorial_7 = {
         text = {
            ...
            function()
               local chest = Item.create(Chara.player().position, "elona.chest", 0)
               chest.param1 = 35
               chest.param2 = 25
               Item.create(Chara.player().position, "elona.lockpick", 2)
               GUI.txt(I18N.get("core.common.something_is_put_on_the_ground"))
            end,
      ...
      start_tutorial = {
         ...
         on_finish = function()
            local corpse = Item.create(Chara.player().position, "elona.corpse", 0)
            corpse.subname = 9
      ...
      identify_done = {
         ...
         on_finish = function()
            local item = Item.create(Chara.player().position, "elona.long_bow", 0)
            item.curse_state = "Cursed"
            item = Item.create(Chara.player().position, "elona.arrow", 0)
            item.curse_state = "None"
            item = Item.create(Chara.player().position, "elona.scroll_of_vanish_curse", 0)
      ...
      equip_done = {
         ...
         on_finish = function()
            ...
            for i=0,2 do
               local putit = Chara.create(Chara.player().position, "elona.putit")
               putit:set_flag("IsNotAttackedByEnemy", true)
            end
            local item = Item.create(Chara.player().position, "elona.potion_of_cure_minor_wound", 0)
            item.identify_state = "Completely"
