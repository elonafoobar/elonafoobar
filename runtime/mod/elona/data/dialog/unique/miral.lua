...
local function upgrade_cargo_limit()
   ...
   local small_medals = Item.find("elona.small_medal", "PlayerInventory")

   GUI.txtnew()
   GUI.txt(I18N.get(
          "elona.talk.unique.miral.upgrade_cart.give.limit_increased",
          Item.weight_string(amount)))
   GUI.play_sound("elona.build1")
