...
return {
   ...
   nodes = {
      ...
      quest_finish = {
         text = {
            function()
               local item = Item.create(Chara.player().position, "elona.material_kit", 0)
               item:change_material("elona.dragon_scale")
               Item.create(Chara.player().position, "elona.gold_piece", 25500)
