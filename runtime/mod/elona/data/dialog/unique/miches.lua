...
return {
   ...
   nodes = {
      ...
      quest_finish = {
         text = {
            function()
               Item.create(Chara.player().position, {id = "elona.small_shield", level = 10, quality = "Good"})
               Item.create(Chara.player().position, {id = "elona.girdle", level = 10, quality = "Good"})
               Item.create(Chara.player().position, "elona.gold_piece", 3000)
