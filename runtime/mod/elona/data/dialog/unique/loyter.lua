   ...
   nodes = {
      ...
      quest_begin_yes = {
         ...
         on_finish = function()
            ...
            Internal.go_to_quest_map("elona.vernis", 5)
         end
      },
      quest_begin_no = {
         text = {
      ...
      quest_finish = {
         text = {
            function()
               local item = Item.create(Chara.player().position, {id = "elona.material_kit", nostack = true})
               item:change_material("elona.rubynus")
               Item.create(Chara.player().position, "elona.gold_piece", 100000)
