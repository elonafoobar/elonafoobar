   ...
   nodes = {
      __start = function()
         ...
         elseif flag == 1000 then
            if Map.id() == "elona.noyel" and Map.area().christmas_festival then
               return "festival"
            end
            return "end_life"
         elseif flag > 7 then
      ...
      last = {
         text = {
            ...
            {"progress.last._1"},
            function()
               Item.create(Chara.player().position, "elona.happy_apple", 0)
               Item.create(Chara.player().position, "elona.gold_piece", 20000)
               Item.create(Chara.player().position, "elona.platinum_coin", 4)
