...
return {
   id = "kaneda_bike",
   root = "elona.talk.unique.kaneda_bike",
   nodes = {
      __start = function()
      ...
      check_drug = function()
         if Item.find("elona.blue_capsule_drug", "PlayerInventory") ~= nil then
      ...
      give_drug = {
         text = {
            function()
               local drug = Item.find("elona.blue_capsule_drug", "PlayerInventory")
