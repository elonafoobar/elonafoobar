...
return {
   ...
   nodes = {
      ...
      quest_finish = {
         ...
         on_finish = function()
            local material_kit = Item.create(Chara.player().position, {id = "elona.material_kit", nostack = true})
            material_kit:change_material("elona.adamantium")
            Item.create(Chara.player().position, "elona.gold_piece", 50000)
