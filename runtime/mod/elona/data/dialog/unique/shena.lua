...
return {
   ...
   nodes = {
      ...
      quest_finish = {
         text = {
            function()
               local rod_of_identify = Item.create(Chara.player().position, "elona.rod_of_identify", 0)
               rod_of_identify.count = 12
               local monster_ball = Item.create(Chara.player().position, {id = "elona.monster_ball", nostack = true})
               monster_ball.param2 = 5
               Item.create(Chara.player().position, "elona.gold_piece", 1500)
