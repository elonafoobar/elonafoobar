...
I18N.add_data_text(
   "core.race",
   {
      ...
      elea = {
         name = "エレア",
         description = "エレアは、幾つもの世代を生き抜いたエルフの末裔で、他の種族から姿を隠し、静かに生活しています。彼らこそが、レム・イドを滅ぼした災厄の元凶であるとするザナンの皇子のバッシングにより、彼らは他の種族から嫌われています。エレアはエーテルへの耐性と高い魔力を持ち、魔力の反動によるダメージを軽減することができます。"
      },
      rabbit = {
         name = "ウサギ",
      },
